...
from splatfacto_2dgs.splatfacto_2dgs import Splatfacto2DGSModel, Splatfacto2DGSModelConfig


@dataclass
class InstructGS2GSModelConfig(Splatfacto2DGSModelConfig):
...
class InstructGS2GSModel(Splatfacto2DGSModel):
    """Model for InstructGS2GS."""
